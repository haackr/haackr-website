...
Finally, add a custom domain to the site you've created. You cannot get the deal with the provided gatsbyjs.io domain that they provide you. If you don't have a domain ready to go for your project, I've had good experiences with both [namecheap](https://namecheap.com) and [google domains](https://domains.google/).
